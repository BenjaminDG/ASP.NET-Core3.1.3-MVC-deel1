...
namespace Razor.Services
{
    public class PersoonService
    {
        ...
        {
            {1, new Persoon{ID =1, Voornaam="Jesse", Familienaam="James", Score=5,Wedde=1000,
                Paswoord="12333333",HerhaalPaswoord="12333333", Geboren=new DateTime(1966,1,1), Gehuwd=true,
                Opmerkingen="Outlaw Wilde Westen", Geslacht=Geslacht.Man }

            },
            { 2, new Persoon {ID=2, Voornaam = "Jane", Familienaam = "Calamity", Score=4,
                Wedde=2000, Paswoord="12333333", Geboren=new DateTime(1966,2,2), Gehuwd=true,
                Opmerkingen="Martha Jane Cannary", Geslacht=Geslacht.Vrouw, HerhaalPaswoord="12333333"}
            },
            { 3, new Persoon {ID=3, Voornaam="Billy",Familienaam="The Kid", Score=5,
                Wedde=3000, Paswoord="12333333", Geboren=new DateTime(1966,3,3), Gehuwd=false,
                Opmerkingen="Revolverheld", Geslacht=Geslacht.Man, HerhaalPaswoord="12333333" }
            },
            { 4, new Persoon {ID=4, Voornaam="Sarah",Familienaam="Bernhardt", Score=3,
                Wedde=4000, Paswoord="12333333", Geboren=new DateTime(1966,4,4), Gehuwd=false,
                Opmerkingen="Rosine Bernardt", Geslacht=Geslacht.Vrouw,HerhaalPaswoord="12333333"}
            }
        };
        public List <Persoon> FindAll() { return personen.Values.ToList(); }
